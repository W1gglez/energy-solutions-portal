                            ...
                            <Card>
                                <CardContent>
                                    ...
                                    <Typography variant="body2" color="text.secondary">
                                        <strong>Years in Business: </strong>{facility.years_in_business}
                                    </Typography>
                                    <Typography variant="body2" color="text.secondary">
                                    <strong> Building Age: </strong>{facility.building_age}
                                    </Typography>
                                    <Typography variant="body2" color="text.secondary">
                                    <strong> Hours of Operation: </strong>{facility.hours_of_operation}
                                    </Typography>
                                    <Typography variant="body2" color="text.secondary">
                                    <strong> Number of Guests: </strong>{facility.weekly_customers}
                                    </Typography>
                                    <Typography variant="body2" color="text.secondary">
                                    <strong> Sit Down Restaurant: </strong>{facility.sit_down ? 'Yes' : 'No'}
                                    </Typography>
                                </CardContent>
                                <CardActions>
                                    <Button size="small" onClick={() => handleEditClick(facility)}>Edit</Button>
                                    <Button size="small" onClick={() => handleDeleteClick(facility)}>Delete</Button>
                                </CardActions>
                            </Card>
