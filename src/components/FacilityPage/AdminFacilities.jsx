							...
							<tr key={facility.id}>
								{editRowId === facility.id ? (
									<>
										...
										<td>
											<input type='text' name='state' value={editFormData.state} onChange={handleChange} />
										</td>
										<td>
											<input type='text' name='zip' value={editFormData.zip} onChange={handleChange} />
										</td>
										<td>
											<input
												type='text'
										...
										<td>
											<input type='text' name='sit_down' value={editFormData.sit_down} onChange={handleChange} />
										</td>
										<td>
									...
									<>
										...
										<td>
											<Button variant='secondary' onClick={() => handleEditClick(facility)}>
												Edit
											</Button>
											<Button variant='danger' onClick={() => handleDeleteClick(facility)}>
												Delete
											</Button>
										</td>
									</>
